    ...
    volatile struct gpio_register*gpio )
{
  ...
  result.x = OUT_XL_X.signed_value*2.0/32768.0*9.80665;
  result.y = OUT_XL_Y.signed_value*2.0/32768.0*9.80665;
  result.z = OUT_XL_Z.signed_value*2.0/32768.0*9.80665;
    ...
    volatile struct gpio_register*gpio )
{
  ...
  result.x = OUT_X_G.signed_value*245.0/32768.0;
  result.y = OUT_Y_G.signed_value*245.0/32768.0;
  result.z = OUT_Z_G.signed_value*245.0/32768.0;
    ...
    volatile struct gpio_register*gpio )
{
  ...
  result.x = OUT_X_M.signed_value*4.0/32768.0;
  result.y = OUT_Y_M.signed_value*4.0/32768.0;
  result.x = OUT_Z_M.signed_value*4.0/32768.0;
